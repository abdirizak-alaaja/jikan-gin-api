...
type UsersBase struct {
	...
	Url        string    `json:"url"`
	Images     common.Images1   `json:"images"`
...
func GetUsersSearch(query url.Values) (*UsersSearch, error) {
	res := &UsersSearch{}
	err := helper.UrlToStruct(fmt.Sprintf("/users?%s", query.Encode()), res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func GetUserByID(id int) (*UserByID, error) {
	res := &UserByID{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/userbyid/%d", id), res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func GetUserProfile(username string) (*UserProfile, error) {
	res := &UserProfile{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s",
...
func GetUserStatistics(username string) (*UserStatistics, error) {
	res := &UserStatistics{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/statistics",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
type UserFavorites struct {
	Data struct {
		...
		People []common.EntryName2 `json:"people"`
	} `json:"data"`
}
...
func GetUserFavorites(username string) (*UserFavorites, error) {
	res := &UserFavorites{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/favorites",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserUpdates(username string) (*UserUpdates, error) {
	res := &UserUpdates{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/userupdates",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserAbout(username string) (*UserAbout, error) {
	res := &UserAbout{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/about",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserFriends(username string) (*UserFriends, error) {
	res := &UserFriends{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/friends",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
type UserAnimelist struct {
	Data []struct {
		...
		Anime           anime.AnimeBase `json:"anime"`
	} `json:"data"`
}
...
func GetUserAnimelist(username string) (*UserAnimelist, error) {
	res := &UserAnimelist{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/animelist",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
type UserMangalist struct {
	Data []struct {
		...
		Priority      string    `json:"priority"`
		Manga         manga.MangaBase `json:"manga"`
	} `json:"data"`
}
...
func GetUserMangalist(username string) (*UserMangalist, error) {
	res := &UserMangalist{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/mangalist",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserReviews(username string) (*UserReviews, error) {
	res := &UserReviews{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/reviews",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserRecommendations(username string) (*UserRecommendations, error) {
	...
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/recommendations",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
...
func GetUserClubs(username string) (*UserClubs, error) {
	res := &UserClubs{}
	err := helper.UrlToStruct(fmt.Sprintf("/users/%s/clubs",
		url.QueryEscape(username)), res)
	if err != nil {
		return nil, err
	}
