...
func GetWatchRecentEpisodes() (*WatchEpisodes, error) {
	res := &WatchEpisodes{}
	err := helper.UrlToStruct("/watch/episodes", res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func GetWatchPopularEpisodes() (*WatchEpisodes, error) {
	res := &WatchEpisodes{}
	err := helper.UrlToStruct("/watch/episodes/popular", res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func GetWatchRecentPromos() (*WatchPromos, error) {
	res := &WatchPromos{}
	err := helper.UrlToStruct("/watch/promos", res)
	if err != nil {
		return nil, err
	}
	return res, nil
...
func GetWatchPopularPromos() (*WatchPromos, error) {
	res := &WatchPromos{}
	err := helper.UrlToStruct("/watch/promos/popular", res)
	if err != nil {
		return nil, err
	}
	return res, nil
